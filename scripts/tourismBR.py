...
for i, patch in enumerate(ax.patches):ax.text(x=patch.get_x( )+patch.get_width( )/2., y=patch.get_height( )-50000, s=labels[i], ha='center', va='top', fontsize=10, fontweight='bold', rotation='vertical', color='#FFFFFF')
st.pyplot ( fig )
plt.close ( fig )
st.divider(     )
# Monthly
