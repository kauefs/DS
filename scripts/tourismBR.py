...
plt.title('International Tourist Arrivals in Brazil ({}–{}) by Continent'.format(DD['year'].min(), DD['year'].max()), fontsize= 15, fontweight='bold')
plt.yticks(fontsize=13, fontweight='semibold', rotation='horizontal')
plt.xticks([])
plt.ylabel(None)
plt.xlabel(None)
...
plt.title('International Tourist Arrivals in Brazil ({}–{}) by Arrival Estate'.format(DD['year'].min() , DD['year'].max()), fontsize= 15, fontweight='bold')
plt.yticks(fontsize=13, fontweight='semibold', rotation='horizontal')
plt.xticks([])
plt.ylabel(None)
plt.xlabel(None)
