...
st.sidebar.divider(                      )
st.sidebar.header(   'International Tourists Arrivals in Brazil')
...
# MAIN:
st.divider(            )
st.title(   'International Tourists Arrivals in Brazil')
st.divider(            )
st.markdown('''
...
plt.title('International Tourists Arrivals in Brazil',   fontsize=20,          fontweight='bold')
