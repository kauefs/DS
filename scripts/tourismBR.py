...
plt.title('Brazil: Annual International Tourist Arrivals ({}–{})'.format(DD['year'].min(), DD['year'].max()), fontsize= 20, fontweight='bold')
...
plt.title('Brazil: Monthly International Tourist Arrivals ({}–{})'.format(DD['year'].min(), DD['year'].max()),   fontsize= 15, fontweight='bold')
plt.yticks(ax.yaxis.set_major_formatter(ticker.StrMethodFormatter('{x:,.0f}')))
...
plt.title('Brazil: International Tourist Arrivals ({}–{}) by Means of Travel'.format(DD['year'].min(), DD['year'].max()),  fontsize= 15, fontweight='bold')
...
plt.title('Brazil: International Tourist Arrivals ({}–{}) by Continent'.format(DD['year'].min(), DD['year'].max()),   fontsize= 20, fontweight='bold')
plt.yticks(fontsize=13, fontweight='semibold', rotation='horizontal')
plt.xticks([])
plt.ylabel(None)
plt.xlabel(None)
...
plt.title('Brazil: Top International Tourist Arrivals ({}–{}) by Country'.format(DD['year'].min(), DD['year'].max()),   fontsize= 15, fontweight='bold')
plt.yticks(fontsize=13, fontweight='semibold', rotation='horizontal')
plt.xticks([])
plt.ylabel(None)
plt.xlabel(None)
...
plt.title('Brazil: International Tourist Arrivals ({}–{}) by Arrival Estate'.format(DD['year'].min(), DD['year'].max()),   fontsize= 20, fontweight='bold')
plt.yticks(fontsize=13, fontweight='semibold', rotation='horizontal')
plt.xticks([])
plt.ylabel(None)
plt.xlabel(None)
